...
namespace LostArkM {
	...
	/// <summary>
	/// Card_le_advancedForm에 대한 요약입니다.
	/// </summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label14->Text = L"[전설:2.5%, 영웅:17.5%, 희귀:40%, 고급:40% 설정]";
			// 
			// label8
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->label8->Text = "";
		this->label6->Text = advanced_simul->legend_count + " 장";
		this->label7->Text = advanced_simul->hero_count + " 장";
		this->label11->Text = advanced_simul->rare_count + " 장";
		this->label13->Text = advanced_simul->advanced_count + " 장";
		this->label9->Text = "총 " + advanced_simul->count + " 장";
	}
