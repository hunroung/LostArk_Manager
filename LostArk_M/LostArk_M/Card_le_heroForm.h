...
namespace LostArkM {
	...
	/// <summary>
	/// Card_le_heroForm에 대한 요약입니다.
	/// </summary>
	public ref class Card_le_heroForm : public System::Windows::Forms::Form
	{
	public:
		Card_le_heroForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Card_le_heroForm::typeid));
			...
			this->label1->Click += gcnew System::EventHandler(this, &Card_le_heroForm::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(54, 132);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(135, 31);
			this->label2->TabIndex = 0;
			this->label2->Text = L"영웅 카드 팩";
			this->label2->Click += gcnew System::EventHandler(this, &Card_le_heroForm::label1_Click);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(129)));
			this->button1->Location = System::Drawing::Point(60, 227);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(90, 36);
			this->button1->TabIndex = 1;
			this->button1->Text = L"1장 열기";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Card_le_heroForm::button1_Click);
			// 
			// button2
			// 
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(129)));
			this->button2->Location = System::Drawing::Point(252, 227);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(90, 36);
			this->button2->TabIndex = 1;
			this->button2->Text = L"10장 열기";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Card_le_heroForm::button2_Click);
			// 
			// label3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Card_le_heroForm::button3_Click_1);
			// 
			// label5
			// 
			...
			this->label6->Click += gcnew System::EventHandler(this, &Card_le_heroForm::label1_Click);
			// 
			// label7
			// 
			...
			this->label7->Location = System::Drawing::Point(283, 132);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(59, 31);
			this->label7->TabIndex = 0;
			this->label7->Text = L"0 장";
			this->label7->Click += gcnew System::EventHandler(this, &Card_le_heroForm::label1_Click);
			// 
			// Card_le_heroForm
			// 
			...
			this->Name = L"Card_le_heroForm";
			this->Load += gcnew System::EventHandler(this, &Card_le_heroForm::Card_le_heroForm_Load);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->label8->Text = "";
		this->label6->Text = simul->legend_count + " 장";
		this->label7->Text = simul->hero_count + " 장";
		this->label9->Text = "총 "+simul->count + " 장";
	}
private: System::Void Card_le_heroForm_Load(System::Object^ sender, System::EventArgs^ e) {
}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	for (int i = 0; i < 5; i++) {
		simul->legend_hero();
		simul->count++;
		result1 += simul->result;
		result1 += "\n";
	}
	for (int i = 0; i < 5; i++) {
		simul->legend_hero();
		simul->count++;
		result2 += simul->result;
		result2 += "\n";
	}
