...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button3->Click += gcnew System::EventHandler(this, &CardSimulForm::button3_Click_1);
			// 
			// label5
			// 
			...
			this->label6->Click += gcnew System::EventHandler(this, &CardSimulForm::label1_Click);
			// 
			// label7
			// 
			...
			this->label7->Click += gcnew System::EventHandler(this, &CardSimulForm::label1_Click);
			// 
			// CardSimulForm
			// 
