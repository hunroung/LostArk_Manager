...
namespace LostArkM {
	...
	/// AbyssForm에 대한 요약입니다.
	/// </summary>
	public ref class AbyssForm : public System::Windows::Forms::Form
	{
	public:
		AbyssForm(void)
		{
	...
	private: System::Windows::Forms::Label^ label9;
		   //클래스 선언
	private: Card::Cardsimulator^ abyss = gcnew Card::Cardsimulator();
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AbyssForm::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &AbyssForm::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &AbyssForm::button2_Click);
			// 
			// panel1
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &AbyssForm::button3_Click);
			// 
			// label5
			// 
			...
			this->label5->Location = System::Drawing::Point(125, 10);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(206, 31);
			this->label5->TabIndex = 0;
			this->label5->Text = L"심연의 전설 카드 팩";
			...
			this->label11->Size = System::Drawing::Size(125, 31);
			this->label11->TabIndex = 11;
			this->label11->Text = L"진저웨일 X";
			// 
			// label12
			// 
			...
			this->label16->Text = L"광기군단장 쿠크 X";
			// 
			// label17
			// 
			...
			this->label17->Text = L"마수군단장 발탄 X";
			// 
			// label18
			// 
			...
			this->label18->Size = System::Drawing::Size(196, 31);
			this->label18->TabIndex = 18;
			this->label18->Text = L"에스더 갈라투르 X";
			// 
			// label19
			// 
			...
			this->label19->Size = System::Drawing::Size(175, 31);
			this->label19->TabIndex = 19;
			this->label19->Text = L"에스더 루테란 X";
			// 
			// label20
			// 
			...
			this->label20->Size = System::Drawing::Size(175, 31);
			this->label20->TabIndex = 20;
			this->label20->Text = L"아제나 이난나 X";
			// 
			// label21
			// 
			...
			this->label21->Size = System::Drawing::Size(154, 31);
			this->label21->TabIndex = 21;
			this->label21->Text = L"에스더 시엔 X";
			// 
			// label22
			// 
			...
			this->label22->Size = System::Drawing::Size(146, 31);
			this->label22->TabIndex = 22;
			this->label22->Text = L"베아트리스 X";
			// 
			// label23
			// 
			...
			this->label23->Size = System::Drawing::Size(146, 31);
			this->label23->TabIndex = 23;
			this->label23->Text = L"아브렐슈드 X";
			// 
			// label24
			// 
			...
			this->label30->Location = System::Drawing::Point(125, 232);
			...
			this->label36->Location = System::Drawing::Point(390, 112);
			...
			this->label37->Location = System::Drawing::Point(390, 142);
			...
			this->label38->Location = System::Drawing::Point(370, 172);
			...
			this->label39->Location = System::Drawing::Point(370, 202);
			...
			this->label40->Location = System::Drawing::Point(350, 232);
			...
			this->label41->Location = System::Drawing::Point(340, 262);
			...
			this->label42->Location = System::Drawing::Point(340, 292);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		std::string legendlist[19] = { "카멘","웨이","샨디","카단","실리안","니나브","진저웨일","일리아칸","바훈투르","욕망군단장 비아키스","광기를 잃은 쿠크세이튼","광기군단장 쿠크세이튼","마수군단장 발탄","에스더 갈라투르","에스더 루테란","아제나 이난나","에스더 시엔","베아트리스","아브렐슈드"};
		std::string result = "";
		int num = abyss->legend_card();
		abyss->count++;
		result = legendlist[num];
		String^ legendresult = gcnew String(result.c_str());
		this->label4->Text = legendresult;
		this->label8->Text = "";
		this->label24->Text = abyss->legend1 + "";
		this->label25->Text = abyss->legend2 + "";
		this->label26->Text = abyss->legend3 + "";
		this->label27->Text = abyss->legend4 + "";
		this->label28->Text = abyss->legend5 + "";
		this->label29->Text = abyss->legend6 + "";
		this->label30->Text = abyss->legend7 + "";
		this->label31->Text = abyss->legend8 + "";
		this->label32->Text = abyss->legend9 + "";
		this->label33->Text = abyss->legend10 + "";
		this->label34->Text = abyss->legend11 + "";
		this->label35->Text = abyss->legend12 + "";
		this->label36->Text = abyss->legend13 + "";
		this->label37->Text = abyss->legend14 + "";
		this->label38->Text = abyss->legend15 + "";
		this->label39->Text = abyss->legend16 + "";
		this->label40->Text = abyss->legend17 + "";
		this->label41->Text = abyss->legend18 + "";
		this->label42->Text = abyss->legend19 + "";
		this->label9->Text = "총 " + abyss->count + " 장";
	}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	for (int i = 0; i < 5; i++) {
		abyss->count++;
		result = legendlist[abyss->legend_card()];
